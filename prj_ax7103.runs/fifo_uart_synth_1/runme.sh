...
HD_PWD='F:/workspace/project/prj_ax7103/prj_ax7103/prj_ax7103.runs/fifo_uart_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_uart.tcl
